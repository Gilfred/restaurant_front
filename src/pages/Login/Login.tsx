    ...
    <div className="min-h-screen w-full flex items-center justify-center p-4 sm:p-6 lg:p-8 font-sans selection:bg-accent-neon/30 overflow-hidden relative">
      ...
      >
        ...
        <button
            ...
            className="w-full py-4 bg-white/5 border border-white/10 hover:bg-white/10 text-text-primary-light dark:text-text-primary-dark rounded-2xl font-bold text-lg flex items-center justify-center gap-2 transition-all mt-4"
        >
